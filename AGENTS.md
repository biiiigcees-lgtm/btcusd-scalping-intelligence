...
- **Chart** = TradingView `lightweight-charts` 15m candlesticks (dark terminal theme).

## Stack

- apps/web — Next.js 15 (UI + SSE relay + lightweight-charts)
...
3. ~~Real chart (lightweight-charts)~~ (done)
